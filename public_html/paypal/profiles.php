...
<!--				<p><br></p>-->
				...
				<p><br><a href="https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/authorize?client_id=AWoiHG8w-yaeYyODSBIzJ-awWkLVPo7G9zWJMomAFeMTVw5wyRG_b2pyYxl7a7wB7ByjVLJ0aQ6FdVDj&response_type=code&scope=openid email profile&redirect_uri=https://bootcamp-coders.cnm.edu/~ddeleeuw/cartridge-coders/public_html/paypal/account.php"><img src="../image/paypal-login.png"></img></a><br><br></p>
				</div>
					<div class="row" align="justify">
				<p>As well, logging in with PayPal will allow you to view your own cartridges for sale, add new carterages, leave feedback on buyer/seller and ask questions prior to purchase. If however you prefer not to login with PayPal, just click the buy now button and no data will be sharred with ROMuLess but the transaction will still go through.</p>
