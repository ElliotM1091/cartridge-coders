...
//-d "{sender_batch_header:
//{sender_batch_id: batch_25, email_subject: You have a payment},
//	items:
...
$data = array(
	...
	array(
		"recipient_type" => "EMAIL", "amount" =>
			array("value" => "9.99", "curency" => "USD"),
		"receiver" => "cartridgecoders-buyer@gmail.com",
		"note" => "Thank you.",
		"sender_item_id" => "item_1"),
			array(		"value" => "1.99", "curency" => "USD"),
	"receiver" => "cartridgecoders-facilitator@gmail.com",
	"note" => "Admin Fee.",
	"sender_item_id" => "item_1");
